...
The following I<PCRE2> options are always enabled:
...
=item C<PCRE2_NEVER_BACKSLASH_C>

Prevent the use of the C<\C> escape sequence. This avoids the possibility of
breaking apart multi-byte I<UTF-8> characters.
...
There is a similar file on I<OpenBSD>, I<NetBSD>, and I<macOS> systems:
  ...
  /*
  This file defines aliases for the built-in symbols for FreeBSD file flags,
  and the related constants and predicates. See <sys/stat.h>.
  */
