...
on platforms with I<GNU glibc> (i.e., I<Linux>):
...
slower than C</bin/sh>. The I<raku> equivalent (with a wrapper script) is
3.08 times faster than C</bin/sh>. But don't read too much into these
timings. They aren't meaningful tests. They're only testing process startup
times.
