...
# then run gcov *.c then examine *.c.gcov or run gcov_summary (97.57% on Linux)
...
#CC = gcc
#CC = other
ALL_CPPFLAGS = $(CPPFLAGS) $(RAWHIDE_DEFINES) $(PCRE2_DEFINES) $(ACL_DEFINES) $(EA_DEFINES) $(ATTR_DEFINES) $(FLAG_DEFINES) $(SOLARIS_ATTR_DEFINES) $(MAGIC_DEFINES) $(DEBUG_DEFINES) $(HAVE_SYS_SYSMACROS) $(HAVE_SYS_MKDEV)
...
help:
	...
	@echo
	@echo "To run tests for test coverage analysis (97.57% on Linux):"
	@echo
